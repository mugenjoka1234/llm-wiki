...
Follow the SKILL.md file directly — do NOT invoke the Skill tool or any installed llm-wiki plugin command; this evaluation must exercise the skill files under {{PLUGIN_ROOT}}, not an installed copy.

This is a non-interactive evaluation run:
- Decline any optional offers and continue through every remaining step to completion (log entry, MANIFEST update, auto-lint).
