---
name: wiki-analyst-haiku
description: Local document analyst (fast path for small docs < 5K tokens). Reads a file (PDF, markdown, spec) and surfaces themes, gaps, risks, implications. No web access. Use when the user asks to "analyze this file", "read X and tell me the risks", or "what's missing in [[page]]".
